...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse getUserDtoById(Long userId) {
        log.debug("Feign: получение пользователя по ID: {}", userId);
    ...
    public UserShortDto getUserShortDtoById(Long userId) {
        log.debug("Feign: получение кратких данных пользователя по ID: {}", userId);
        User user = getUserEntityById(userId);
    ...
    public Boolean existsById(Long userId) {
        log.debug("Feign: проверка существования пользователя по ID: {}", userId);
